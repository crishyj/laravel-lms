                                        ...
                                        @forelse($options as $option)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{route('grade.delete', $option->id)}}" onclick="return window.confirm('Are you sure?')" class="btn btn-danger mb-2 mr-1  btn-sm btn-delete" data-toggle="tooltip" data-placement="bottom" title=""><i class="fa fa-trash"></i> {{ __('lang.delete')}}</a>    
                                                </td>                       
                                            </tr>
                                        @empty       
        ...
        <div class="modal-content">
            <form action="" method="post" id="edit_form" enctype="multipart/form-data">
                ...
                <div class="modal-header">
                    <h4 class="modal-title">{{ __('lang.edit_grade')}}</h4>
                    <button type="button" class="close" data-dismiss="modal">×</button>
                </div>
                <div class="modal-body">
                    <input type="hidden" name="id" class="id" id ="id" />
                    <div class="form-group">
                        <label for="name" class="font-weight-600"> {{ __('lang.grade_name')}} :</label>
