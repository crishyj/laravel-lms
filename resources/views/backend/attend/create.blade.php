                                ...
                                <table id="adminList_table" class="table  w-100 text-center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" onclick="return window.confirm('Are you sure?')" class="btn btn-success mb-2 mr-1  btn-sm  submit_btn" data-placement="bottom" title="" data-modal="modal-1"><i class="fas fa-edit"></i> {{ __('lang.take_attend')}} </a>
                                            </td>                       
                                        </tr>
            ...
            $(document).on('click', '.submit_btn', function (){
                ...
                $.ajax({
                    ...
                    success : function(response) {
                        if(response == 'success') {                          
                            window.location.replace('../attend/list/')
                        } else {
