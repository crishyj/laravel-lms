                                        ...
                                        @forelse($assignments as $assignment)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{route('assignment.delete', $assignment->id)}}" onclick="return window.confirm('Are you sure?')" class="btn btn-danger mb-2 mr-1  btn-sm btn-delete" data-toggle="tooltip" data-placement="bottom" title=""><i class="fa fa-trash"></i>  {{ __('lang.delete')}} </a>    
                                                </td>                       
                                            </tr>
                                        @empty       
        ...
        <div class="modal-content">
            <form action="" method="post" id="edit_form" enctype="multipart/form-data">
                ...
                <div class="modal-header">
                    <h4 class="modal-title"> {{ __('lang.edit_assign')}} </h4>
