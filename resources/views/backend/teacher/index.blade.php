                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="page-title-box">                   
                                <h4 class="page-title">{{ __('lang.teacher_list')}}</h4>
                            </div>
                                    ...
                                    <tbody>
                                        @forelse($options as $option)
                                            <tr>
                                                ...
                                                <input type="hidden" name="subject" class="subject" value="{{$option->subject}}" />
                                                ...
                                                <td>
                                                    <a href="#" class="btn btn-success mb-2 mr-1  btn-sm  modal-btn2" data-id="{{$option->id}}" data-toggle="tooltip" data-placement="bottom" title="" data-modal="modal-1"><i class="fas fa-edit"></i>Edit</a>                                                                                                                 
                                                    <a href="{{route('teacher.delete', $option->id)}}" onclick="return window.confirm('Are you sure?')" class="btn btn-danger mb-2 mr-1  btn-sm btn-delete" data-toggle="tooltip" data-placement="bottom" title=""><i class="fa fa-trash"></i> Delete</a>    
                                                </td>                       
                                            </tr>
                                        @empty       
        ...
        <div class="modal-content">
            <form action="" method="post" id="edit_form" enctype="multipart/form-data">
                ...
                <div class="modal-header">
                    <h4 class="modal-title">{{ __('lang.edit_teacher')}}</h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="subject" class="font-weight-600"> {{ __('lang.subject')}}:</label>
                        <input type="text" name="subject" id="subject" class="form-control subject" required>
                    </div>  
    ...
    <script>
        $(document).ready(function(){
            $(document).on('click', '.modal-btn2', function (){
                ...
                let subject = $(this).parents('tr').find('.subject').val().trim();
