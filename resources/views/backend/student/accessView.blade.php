                                    ...
                                    <tbody>
                                        @forelse($students as $student)
                                            <tr>
                                                ...
                                                <input type="hidden" name="email" class="email" value="{{$student->email}}">
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{route('studentAccess.delete', $student->id)}}" onclick="return window.confirm('Are you sure?')" class="btn btn-danger mb-2 mr-1  btn-sm btn-delete" data-toggle="tooltip" data-placement="bottom" title=""><i class="fa fa-trash"></i> {{ __('lang.delete')}}</a>    
                                                </td>                       
                                            </tr>
                                        @empty       
