                                    ...
                                    <tbody>
                                        @forelse($students as $student)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#" onclick="return window.confirm('Are you sure?')" class="btn btn-success mb-2 mr-1  btn-sm  submit_btn" data-placement="bottom" title="" data-modal="modal-1"><i class="fas fa-edit"></i>{{ __('lang.approve')}}</a>
                                                        <a href="{{route('approveStudent.delete', $student->id)}}" onclick="return window.confirm('Are you sure?')" class="btn btn-danger mb-2 mr-1  btn-sm btn-delete" data-toggle="tooltip" data-placement="bottom" title=""><i class="fa fa-trash"></i> {{ __('lang.delete')}}</a>    
                                                    </td>                       
                                                </tr>
    ...
    <script>
        $(document).ready(function(){
            $(document).on('click', '.submit_btn', function (){
                ...
                $.ajax({
                    url: "{{route('approveStudent.update')}}",
                    type: 'POST',
                    dataType: 'json',
                    data: form_data,
                    cache: false,
